    ...
    return(
        ...
        {/* modal */}
            ...
            <View style={{flexDirection:'row',alignItems: 'center',justifyContent: 'space-between',bottom:30}}>
                    <TouchableOpacity  style={{right:100}} onPress={() => setModalVisible(false)}  >
                    <AntDesign style={styles.optionButton} name="menuunfold" size={25} color={Colors.secondary}/>
                  </TouchableOpacity>
                  <TouchableOpacity  style={{left:70}}  onPress={() => setModalVisible(false)}  >
           ...
           {/* Imageslider starts   */}
                ...
                <View style={{flexDirection:'column',}}>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('Agricultural2')}>
                    <View style={styles.boxContainer}>
