                   ...
                   borderRadius:14,
                    ...
                    <TouchableOpacity style={{alignItems:'flex-end',top:10,right:10}}
                      onPress={()=> navigation.goBack(null)}>
                            <EvilIons name="close" size={25} flexDirection='row' alignItems='flex-end' color={Colors.buttonColor}/>
                        </TouchableOpacity>
                       ...
                       paddingBottom:10}}>
                        ...
                        <Text style={styles.styletext}>
                            ...
                            confirm the information by visiting the bank/branch/property concerned.
                            </Text>
                         ...
                         <Text style={styles.styletext}>
                             ...
                             sell or the solicitation of an offer to buy any property or service; and should not be
                              treated as recommendation in connection with any investment decision.
                              {'\n'}  
                              {'\n'}
                              ...
                              convenience and the inclusion of any link does not imply endorsement by of the referenced site.
                              {'\n'}  
                              {'\n'}
