...
import { Text,View,SafeAreaView,StyleSheet,Image, TouchableOpacity,TextInput, ToastAndroid, ScrollView,Button} from 'react-native';
...
<ScrollView
    ...
    >
       ...
       {/* Edited field      */}
       <View Reset PasswordReset Password>
     ...
     <TouchableOpacity onPress={Postcall()} style={{height:50,width:150,backgroundColor:'blue'}}>
       <Text>post method</Text></TouchableOpacity>
