...
import ResetPage from '../screens/pages/Resetpwd'
...
import Agricultural2 from '../screens/Property/Agricultural1'
...
import PropertyViewHeader from '../components/PropertyViewHeader'
...
const HomeScreenStack = () => {
    return (
       ...
       <Stack.Screen name="Firstpage" component={Firstpage} options={{ headerShown: false }} />
        ...
        <Stack.Screen name="Agricultural2" component={Agricultural2} options={{ headerShown: false }} /> 
        ...
        <Stack.Screen name="PropertyViewHeader" component={PropertyViewHeader}  options={{ headerShown: false }} />   
